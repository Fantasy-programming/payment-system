...
import type { IRosGenericResponse } from "./IROS"
...
export class Channel extends EventEmitter {
   ...
   * @returns {Promise}
   */
  public write(params: string[], isStream = false, returnPromise = true): Promise<IRosGenericResponse[]> {
   ...
   *
   * @param force - force closing by removing all listeners
   */
